...
options=(
1 "Add [alg-repo] to /etc/pacman.conf (if missing)" off
...
sed -i 's/alg_repo/alg-repo/g' pacman.conf
...
sed -i 's/alg_repo/alg-repo/g' $HOME/arch-linux-gui-plasma/pacman.conf
cd $HOME/arch-linux-gui-plasma/
sed -i '/ipw2100-fw/d' packages.x86_64
sed -i '/ipw2200-fw/d' packages.x86_64
sudo mkarchiso -v .
...
sed -i 's/alg_repo/alg-repo/g' $HOME/arch-linux-gui-gnome/pacman.conf
cd $HOME/arch-linux-gui-gnome/
sed -i '/ipw2100-fw/d' packages.x86_64
sed -i '/ipw2200-fw/d' packages.x86_64
sudo mkarchiso -v .
...
sed -i 's/alg_repo/alg-repo/g' $HOME/arch-linux-gui-xfce/pacman.conf
cd $HOME/arch-linux-gui-xfce/
sed -i '/ipw2100-fw/d' packages.x86_64
sed -i '/ipw2200-fw/d' packages.x86_64
sudo mkarchiso -v .
...
sed -i 's/alg_repo/alg-repo/g' $HOME/arch-linux-gui-cinnamon/pacman.conf
cd $HOME/arch-linux-gui-cinnamon/
sed -i '/ipw2100-fw/d' packages.x86_64
sed -i '/ipw2200-fw/d' packages.x86_64
sudo mkarchiso -v .
...
sed -i 's/alg_repo/alg-repo/g' $HOME/alg-plasma-pure/pacman.conf
cd $HOME/alg-plasma-pure/
sed -i '/ipw2100-fw/d' packages.x86_64
sed -i '/ipw2200-fw/d' packages.x86_64
echo kwalletmanager >> packages.x86_64
...
sed -i 's/alg_repo/alg-repo/g' $HOME/alg-gnome-pure/pacman.conf
cd $HOME/alg-gnome-pure/
sed -i '/ipw2100-fw/d' packages.x86_64
sed -i '/ipw2200-fw/d' packages.x86_64
sudo mkarchiso -v .
...
sed -i 's/alg_repo/alg-repo/g' $HOME/alg-xfce-pure/pacman.conf
cd $HOME/alg-xfce-pure/
sed -i '/ipw2100-fw/d' packages.x86_64
sed -i '/ipw2200-fw/d' packages.x86_64
sudo mkarchiso -v .
...
sed -i 's/alg_repo/alg-repo/g' $HOME/alg-i3/pacman.conf
cd $HOME/alg-i3/
sed -i '/ipw2100-fw/d' packages.x86_64
sed -i '/ipw2200-fw/d' packages.x86_64
sudo mkarchiso -v .
...
sed -i 's/alg_repo/alg-repo/g' $HOME/arch-linux-gui-zen/pacman.conf
cd $HOME/arch-linux-gui-zen/
sed -i '/ipw2100-fw/d' packages.x86_64
sed -i '/ipw2200-fw/d' packages.x86_64
sudo mkarchiso -v .
